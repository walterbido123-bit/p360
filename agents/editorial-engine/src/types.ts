...
export type EditorialProvider = "anthropic" | "openai";
...
export type AgentResult = { workflowId: string; eventId: string; agent: AgentName; status: "completed"|"human_review"|"failed"; output: Record<string, unknown>; sources: Source[]; provider?: EditorialProvider; model?: string; durationMs: number };
